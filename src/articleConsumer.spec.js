...
const objOfPact = new PactV3({
  consumer: "ArticleExpectedGQLResult",
...
describe("API Pact test", () => {
    test("Verify Article Contract", async () => {
      await objOfPact.addInteraction({
      ...
      await objOfPact.executeTest(async (mockService) => {
    ...
    test("Second Verify Article Contract", async () => {
        await objOfPact.addInteraction({
          states: [{ description: "Second Verify Article" }],
          uponReceiving: "Second Get Article",
          withRequest: {
            method: "GET",
            path: "/graphql",
            query: {
      ...
      test("Third Verify Article Contract", async () => {
        await objOfPact.addInteraction({
          states: [{ description: "Third Verify Article" }],
          uponReceiving: "Third Get Article",
          withRequest: {
            method: "GET",
            path: "/graphql",
            query: {
      ...
      test("Forth Verify Article Contract", async () => {
        await objOfPact.addInteraction({
          states: [{ description: "Forth Verify Article" }],
          uponReceiving: "Forth Get Article",
          withRequest: {
            method: "GET",
            path: "/graphql",
            query: {
      ...
      test("Fifth Verify Article Contract", async () => {
        await objOfPact.addInteraction({
          states: [{ description: "Fifth Verify Article" }],
          uponReceiving: "Fifth Get Article",
          withRequest: {
            method: "GET",
            path: "/graphql",
            query: {
      ...
      test("Sixth Verify Article Contract", async () => {
        await objOfPact.addInteraction({
          states: [{ description: "Sixth Verify Article" }],
          uponReceiving: "Sixth Get Article",
          withRequest: {
            method: "GET",
            path: "/graphql",
            query: {
